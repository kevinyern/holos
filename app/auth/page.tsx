      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-card border border-surface-border rounded-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-surface-light border border-surface-border text-gray-300 font-medium py-3 min-h-[48px] rounded-xl hover:border-gray-500 hover:text-white transition-colors disabled:opacity-50"
          >
